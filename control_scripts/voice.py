...
def find_commands(recognized_text):
    ...
    command_list = ["stop", "move", "right", "left" ,"forward"]
    for word in words:
        ...
        elif word.lower() == "for" or difflib.SequenceMatcher(None, word.lower(), "forward").ratio() > 0.8:
            detected_commands.append("forward")
